...
Understanding maritime operational data (AIS)

Cleaning and structuring inconsistent real-world datasets

Identifying deviations from normal behavior

Breaking down workflows into modular analytical steps

Summarizing findings in clear, plain language
